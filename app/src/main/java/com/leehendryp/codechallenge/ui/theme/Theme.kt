...
// Lee Mar 25, 2025: The enableDynamicTheming argument allows for easier tests, without
// having to annotate with @RequiresApi(Build.VERSION_CODES.S) or mocking static methods.
@Composable
