...
internal fun PhotoAlbumTheme(
    ...
    CompositionLocalProvider(
        ...
        LocalTypography provides PhotoAlbumTypography,
        LocalDimens provides dimens,
    ) {
        MaterialTheme(
            colorScheme = colorScheme,
            typography = PhotoAlbumTypography,
            content = content,
        )
    }
}

private fun getLightColorScheme(contrastLevel: ContrastLevel): ColorScheme = when (contrastLevel) {
...
private fun getDarkColorScheme(contrastLevel: ContrastLevel): ColorScheme = when (contrastLevel) {
